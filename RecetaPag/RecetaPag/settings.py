"""
Django settings for RecetaPag project.
...
sys.path.append(os.path.join(BASE_DIR, 'RecetaPag'))
...
DATABASES = {
    'default':{
        ...
        'NAME': 'bnfwnkxxtvkdjk6ruxtn',
        'USER': 'ukbnz7iniweubqep',
        'PASSWORD': '2ZgqezQtcp5q61unu4Ft',
        'HOST': 'bnfwnkxxtvkdjk6ruxtn-mysql.services.clever-cloud.com',  # O la IP de tu servidor
